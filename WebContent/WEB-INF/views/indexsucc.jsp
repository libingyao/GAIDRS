			...
			<div class="row d-flex justify-content-center">
				<div class="col-md-12">
					<div class="slider-title_box">
						...
						<div class="row d-flex justify-content-center">
							<div class="col-md-10">
								<form class="form-wrap mt-4" action="returnIndex.do"
									method="post">
									<div style="float: center" role="group"
										aria-label="Basic example" size="30">
										<button type="submit" class="btn-form" style="float: center">
											索引建立成功!<i class="pe-7s-angle-right"></i>
										</button>
										<button type="submit" class="btn-form" style="float: right">
											检索页面<i class="pe-7s-angle-right"></i>
										</button>
									</div>
								</form>
							</div>
