			...
			<div class="row d-flex justify-content-center">
				<div class="col-md-12">
					<div class="slider-title_box">
						...
						<div class="row d-flex justify-content-center">
							<div class="col-md-10">
								<form class="form-wrap mt-4" action="indexIndex.do" method="post">
										<button type="submit" class="btn-form">
											<span class="icon-magnifier search-icon"></span>建立索引页面<i
												class="pe-7s-angle-right"></i>
										</button>
								</form>
								<form class="form-wrap mt-4" action="retrieveIndex.do" method="post">
										<button type="submit" class="btn-form">
											<span class="icon-magnifier search-icon"></span>检索页面<i
												class="pe-7s-angle-right"></i>
										</button>
								</form>
							</div>
